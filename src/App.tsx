...
function App() {
  ...
  return (
    <div className="App">
      <div className="infoBlockUsecases">
        <ol>
          <li>
            При нажатии на поле поиска появляется список пунктов, состоящий из
            стандартных полей либо релевантных к введённому поисковому запросу.
          </li>
          <li>
            ...
            поисковый фрагмент находится не в начале запроса, он не предлагается
            к автозаполнению. Также среди найденных вариантов введённые
            фрагменты запроса выделяются, находись они в начале, середине или
            конце любого из слов.
          </li>
          <li>
      ...
      <div className="infoBlockProps">
        ...
        <ol>
          ...
          <br />
          <li>
            debounceTime - по дефолту выставлено 150, отвечает за длину задержки
            ввода
          </li>
        </ol>
      </div>
